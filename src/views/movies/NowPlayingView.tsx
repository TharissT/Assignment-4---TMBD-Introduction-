...
export const NowPlayingView = () => {
  ...
  return (
    <main className="min-h-screen bg-black text-white relative overflow-x-hidden selection:bg-red-600/50">
      ...
      <section className="relative z-10 max-w-[1600px] mx-auto px-8 md:px-16 py-16 space-y-12 animate-in fade-in slide-in-from-bottom-10 duration-1000">
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-2">
            <div className="flex items-center space-x-3">
              <div className="h-8 w-1.5 bg-red-600 rounded-full animate-pulse" />
              <h2 className="text-zinc-500 uppercase tracking-[0.5em] text-xs font-black">
                Live Broadcast
              </h2>
            </div>
            <h1 className="text-6xl md:text-7xl font-black uppercase tracking-tighter italic text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-zinc-600">
        ...
        <div className="relative group">
          <div className="absolute -inset-1 bg-gradient-to-r from-red-600/20 to-transparent blur-2xl opacity-0 group-hover:opacity-100 transition duration-1000" />
        ...
        <footer className="pt-16 border-t border-zinc-900/50 flex flex-col md:flex-row items-center justify-between gap-12 pb-20">
          <div className="flex flex-col gap-3">
            <p className="text-zinc-600 text-[10px] uppercase tracking-[0.4em] font-bold pl-1">
              Archive Navigation
            </p>
            <div className="relative group">
      ...
      <div className="fixed bottom-0 left-0 w-full h-40 bg-gradient-to-t from-black via-black/80 to-transparent pointer-events-none z-20" />
      
      <div className="absolute top-1/2 -right-64 w-[500px] h-[500px] bg-red-600/5 blur-[120px] rounded-full pointer-events-none animate-pulse" />
    </main>
  );
};