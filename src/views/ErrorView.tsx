...
export const ErrorView = () => {
  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center relative overflow-hidden selection:bg-red-600/50">
      ...
      <div className="absolute top-1/4 w-full h-0.5 bg-red-600/20 blur-sm animate-[bounce_2s_infinite] pointer-events-none" />
      <div className="absolute top-3/4 w-full h-px bg-red-900/40 blur-xs animate-[bounce_3s_infinite] pointer-events-none" />
      ...
      <section className="relative z-10 flex flex-col items-center justify-center space-y-10 group">
        <div className="relative">
          ...
          <div className="absolute -bottom-4 left-0 w-full h-2 bg-red-600 shadow-[0_0_30px_#dc2626] skew-x-20" />
        </div>
        ...
        <div className="pt-6 relative group">
          <div className="absolute -inset-1 bg-linear-to-r from-red-900 via-red-600 to-red-900 rounded-none blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200" />
      ...
      <div className="absolute top-0 left-0 w-full h-32 bg-linear-to-b from-red-900/10 to-transparent pointer-events-none" />
