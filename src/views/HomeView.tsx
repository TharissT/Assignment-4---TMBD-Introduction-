...
export const HomeView = () => {
  ...
  return (
    <main className="min-h-screen bg-black text-white flex items-center justify-center relative overflow-hidden selection:bg-red-600/40">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(rgba(18,18,18,0.3)_1px,transparent_1px),linear-gradient(90deg,rgba(18,18,18,0.3)_1px,transparent_1px)] bg-size-[40px_40px] mask-[radial-gradient(ellipse_at_center,black,transparent_80%)] pointer-events-none" />

      <section className="relative z-10 max-w-4xl w-full text-center space-y-16 px-6">
        {/* Massive Cinematic Logo */}

        <div className="relative group">
          <h1 className="text-[12rem] font-black uppercase tracking-[calc(-0.05em)] italic text-transparent bg-clip-text bg-linear-to-b from-red-500 via-red-600 to-red-950 drop-shadow-[0_20px_50px_rgba(220,38,38,0.4)] animate-[pulse_4s_ease-in-out_infinite]">
            Netflix
          </h1>
        ...
        {/* Minimalist Subtext */}
        <p className="text-zinc-500 text-2xl font-extralight max-w-2xl mx-auto leading-relaxed tracking-widest uppercase">
      ...
      {/* Edge Vignette */}
      <div className="absolute inset-0 ring-120 ring-black ring-inset pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-full h-96 bg-linear-to-t from-black via-black/80 to-transparent pointer-events-none" />
    </main>
  );
};
